// One-line gateway proxy for the acad-selection category.
...
internal static class SelectionProxy
{
    ...
    public static async Task<TResult> CallAsync<TArgs, TResult>(
        IPluginGateway gateway, string pluginToolKey, TArgs args, int timeoutMs, CancellationToken ct)
